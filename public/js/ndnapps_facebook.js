...
!(function(){
    ...
    var ndnappsBlogtestJavaScript = function(jQuery){
        ...
        var blogtest_data_response = JSON.parse(B64.decode(ndn_facebook_data));
            ...
            while (len--) {
                ...
                var frag = (function(){
                    ...
                    if(itemId){
                        ...
                        wrap.innerHTML = '<div class="ndnapps-facebook-wrapper" id="ndnapps-facebook-wrapper"></div>';
                    }
        ...
        jQuery('body').each(function(){
            replacer('\\[ndnapps-facebook]', jQuery(this).get(0), blackList);
        ...
        if(jQuery('#ndnapps-facebook-wrapper').length){
            jQuery("#ndnapps-facebook-wrapper").append(blogtest_data_response);
        }
